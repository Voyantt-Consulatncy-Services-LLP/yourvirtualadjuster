...
<section class="banner-section position-relative" id="home-hero-banner">
    <div class="left-hero-section position-relative">
        <img src="<?php echo esc_url(get_field('hero_image')); ?>" alt="Hero image" class="mobile-mockups">
    </div>
    <div class="right-hero-section">
        <div class="d-flex flex-column justify-content-between align-items-start flex-wrap flex-sm-wrap">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                ?>
                    <div class="line-container p-2 pe-4">
                        <?php if ($icon) : ?>
                            <img src="<?php echo esc_url($icon); ?>" alt="icons">
                        <?php endif; ?>
            ...
            <div class="d-flex mt-3">
                ...
                <a href="tel:<?php the_field('call_button_link'); ?>" class="btn btn-secondary text-uppercase px-4 py-2 rounded me-4 shadow"><img src="<?php echo esc_url(get_field('call_button_icon')); ?>" alt="call-button" class="small-icon me-2"> <?php the_field('call_button_text'); ?></a>

                <a href="<?php the_field('book_demo_button_link'); ?>" class="btn btn-primary text-uppercase px-4 py-2 rounded shadow" target="_blank"><img src="<?php echo esc_url(get_field('book_demo_button_icon')); ?>" alt="book-demo" class="small-icon me-2"> <?php the_field('book_demo_button_text'); ?></a>
            </div>
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
                        ...
                        <?php while (have_rows('our_solutions')) : the_row(); ?>
                            <button class="nav-link <?php echo ($tab_index === 1) ? 'active' : ''; ?>"
                                ...
                                role="tab">
                                <span class="tab-icon">
                                    <img src="<?php the_sub_field('tab_icon'); ?>" alt="icons">
                                </span>
...
<section class="blue-cta">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center blue-bg px-4 py-5 flex-wrap flex-sm-wrap flex-md-nowwrap">
            ...
            <a href="tel:<?php the_field('cta_button_link'); ?>" class="btn btn-secondary text-uppercase px-4 py-2 rounded me-4 shadow"><img src="<?php the_field('cta_button_icon'); ?>" alt="cta-button" class="small-icon me-2"> <?php the_field('cta_button_text'); ?></a>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="left-mobile-holder d-flex justify-content-between align-items-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/large-mobile-mockup.png" alt="large" class="large-mobile">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spark-arrow.svg" alt="spark-arrow" class="d-none d-md-block d-sm-none">
                </div>
            </div>
            <div class="col-md-7">
                                ...
                                <h4 class="accordion-header" id="<?php echo esc_attr($heading_id); ?>">
                                    <button class="accordion-button <?php echo !$is_first ? 'collapsed' : ''; ?>"
                                        ...
                                        <?php if (get_sub_field('accordion_icon')) : ?>
                                            <img src="<?php the_sub_field('accordion_icon'); ?>" alt="accordion_icon" class="me-3">
                                        <?php endif; ?>
        ...
        <?php if (have_rows('manage_claims_cta')): ?>
            <?php while (have_rows('manage_claims_cta')) : the_row(); ?>
                <div class="d-flex justify-content-lg-between justify-content-center align-items-center blue-bg-2 px-4 py-4 mb-5">
                    ...
                    <a href="<?php the_sub_field('pricing_cta_button_link'); ?>" class="btn btn-secondary text-uppercase px-4 py-2 rounded me-lg-4 shadow" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/calender-icon.svg" alt="calender-icon" class="small-icon me-2"> <?php the_sub_field('pricing_cta_button_text'); ?></a>
                </div>
            <?php endwhile; ?>
        <?php endif; ?>
        ...
        <?php if (have_rows('pricing_introduction_section')): ?>
            <?php while (have_rows('pricing_introduction_section')) : the_row(); ?>
                ...
                <div class="card p-5 my-5 d-flex justify-content-between flex-column align-items-center w-75 mx-auto">
                    <span class="bg-primary text-white text-uppercase px-5 py-3 font-20 mb-5 border-radius10" target="_blank">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center blue-bg-3 position-relative">
            ...
            <div class="ylla-logo-holder">
                <img src="<?php the_field('ylla_logo'); ?>" alt="ylla_logo">
            </div>
        </div>
    </div>
</section>
            ...
            <?php if (have_rows('partner_logos')): ?>
                <?php while (have_rows('partner_logos')) : the_row(); ?>
                    <div class="partner-item">
                        <img src="<?php the_sub_field('partner_image'); ?>" alt="partner_image">
                    </div>
                <?php endwhile; ?>
            <?php endif; ?>
        </div>
